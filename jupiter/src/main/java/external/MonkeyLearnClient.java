...
public class MonkeyLearnClient {
	private static final String API_KEY = "0a039f894dbe45dcd8879f09361e5059aa4d5268";// make sure change it to your api key.
  	public static void main(String[] args) {

  		String[] textList = {
  				"Software Engineering in Frontend development React Redux",
